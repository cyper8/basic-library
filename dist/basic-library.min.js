...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.App=App;var _UI=__webpack_require__(7),_UI2=_interopRequireDefault(_UI),_Modules=__webpack_require__(11),_CookieStack=__webpack_require__(10),_CookieStack2=_interopRequireDefault(_CookieStack),_Network=__webpack_require__(12),_Network2=_interopRequireDefault(_Network),_Reader=__webpack_require__(13),_Reader2=_interopRequireDefault(_Reader),_TimerStack=__webpack_require__(14),_TimerStack2=_interopRequireDefault(_TimerStack);__webpack_require__(20);function _interopRequireDefault(b){return b&&b.__esModule?b:{default:b}}var Basic={UI:_UI2.default,System:{Network:_Network2.default,Reader:_Reader2.default,TimerStack:_TimerStack2.default,CookieStack:_CookieStack2.default,ModuleStack:_Modules.ModuleStack}};exports.default=Basic;function App(b,d,f){if(!b)throw new Error('App name cannot be empty');var g=d;if(!g.length)var d=[];if('string'==typeof g,0==d.length){for(var h in Basic.System)d.push(h)}return(f||document)[b]=d.reduce(function(j,k){return j[k]=Basic.System[k]?new Basic.System[k]:'unknown symbol '+k,j},{})}
