...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _addWheelListener=__webpack_require__(18),_addWheelListener2=_interopRequireDefault(_addWheelListener),_isScrolledIntoView=__webpack_require__(19),_isScrolledIntoView2=_interopRequireDefault(_isScrolledIntoView),_Element=__webpack_require__(1),_Element2=_interopRequireDefault(_Element),_Section=__webpack_require__(6),_Controls=__webpack_require__(15),_Progress=__webpack_require__(16),_Progress2=_interopRequireDefault(_Progress),_Progressable=__webpack_require__(2),_Progressable2=_interopRequireDefault(_Progressable),_Scroll=__webpack_require__(5),_Scroll2=_interopRequireDefault(_Scroll),_Scrollable=__webpack_require__(17),_Scrollable2=_interopRequireDefault(_Scrollable);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}exports.default={addWheelListener:_addWheelListener2.default,isScrolledIntoView:_isScrolledIntoView2.default,element:_Element2.default,section:_Section.section,selector:_Controls.selector,label:_Controls.label,progress:_Progress2.default,scroll:_Scroll2.default,DualState:_Controls.DualState,Pushable:_Controls.Pushable,Switchable:_Controls.Switchable,PushButton:_Controls.PushButton,ToggleButton:_Controls.ToggleButton,Progressable:_Progressable2.default,Extendable:_Section.Extendable,Scrollable:_Scrollable2.default};
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.App=App;var _UI=__webpack_require__(7),_UI2=_interopRequireDefault(_UI),_Modules=__webpack_require__(11),_CookieStack=__webpack_require__(10),_CookieStack2=_interopRequireDefault(_CookieStack),_Network=__webpack_require__(12),_Network2=_interopRequireDefault(_Network),_Reader=__webpack_require__(13),_Reader2=_interopRequireDefault(_Reader),_TimerStack=__webpack_require__(14),_TimerStack2=_interopRequireDefault(_TimerStack);__webpack_require__(20);function _interopRequireDefault(b){return b&&b.__esModule?b:{default:b}}var Basic={UI:_UI2.default,System:{Network:_Network2.default,Reader:_Reader2.default,TimerStack:_TimerStack2.default,CookieStack:_CookieStack2.default,ModuleStack:_Modules.ModuleStack}};exports.default=Basic;function App(b){if(!window.Basic)throw new Error('No framework found in window.Basic');var d=b;if(!d.length)var b=[];if('string'==typeof d,0==b.length){for(var f in Basic.System)b.push(f)}return window.Basic.App=b.reduce(function(g,h){return g[h]=Basic.System[h]?new Basic.System[h]:'unknown symbol '+h,g},{})}
...
"use strict";
var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};Object.defineProperty(exports,"__esModule",{value:!0});exports.ajax=ajax;function ajax(a){if("object"!=("undefined"==typeof a?"undefined":_typeof(a)))throw new Error("Argument must be of type: Object");var b=new XMLHttpRequest;if(b.request=a,"undefined"==typeof a.resulthandler)throw new Error("ajax: no handler function!");return b.handler=function(c){"function"==typeof a.resulthandler?a.resulthandler(c):"object"===_typeof(a.resulthandler)&&(a.resulthandler.innerHTML=c)},b.addEventListener("readystatechange",function(){4==this.readyState&&199<this.status&&400>this.status&&this.handler(this.response)}),b.timeout=1e4,b.addEventListener("timeout",function(){0<this.readyState&&4>this.readyState&&this.abort(),this.handler(new Error("Connection timeout"))}),b.addEventListener("error",function(c){b.handler(c)}),a.progresshandler&&("function"==typeof a.progresshandler?(b.upload?b.upload:b).onprogress=function(c){a.progresshandler.call(a,c.lengthComputable?c.loaded/c.total:1)}:"object"===_typeof(a.progresshandler)&&"function"==typeof a.progresshandler.setState&&((b.upload?b.upload:b).onprogress=function(c){a.progresshandler.active?a.progresshandler.value=Math.floor(a.progresshandler.value)+(c.lengthComputable?c.loaded-1/c.total:0.99):a.progresshandler.show(a.progresshandler.total+1)})),a.type?b.responseType=a.type:"GET"==a.method&&0<a.url.search(/\.jp[e]?g$/i)&&(b.responseType="blob"),(b.executesession=function(){if(b.open(a.method,encodeURI(a.url),!0),a.headers){for(var c in a.headers)b.setRequestHeader(c,a.headers[c])}b.send(a.params)})(),b}exports.default=ajax;
...
"use strict";
var _typeof='function'==typeof Symbol&&'symbol'==typeof Symbol.iterator?function(b){return typeof b}:function(b){return b&&'function'==typeof Symbol&&b.constructor===Symbol&&b!==Symbol.prototype?'symbol':typeof b};Object.defineProperty(exports,'__esModule',{value:!0});__webpack_require__(0);var _Fifo=__webpack_require__(3),_Fifo2=_interopRequireDefault(_Fifo),_Progressable=__webpack_require__(2),_Progressable2=_interopRequireDefault(_Progressable),_Suspendable=__webpack_require__(4),_Suspendable2=_interopRequireDefault(_Suspendable),_Ajax=__webpack_require__(9),_Ajax2=_interopRequireDefault(_Ajax);function _interopRequireDefault(b){return b&&b.__esModule?b:{default:b}}exports.default=(0,_Suspendable2.default)(function(){this._xhr=null;var c=!1;this.test=function(d,f){(0,_Ajax2.default)({method:'GET',url:d,resulthandler:f,progresshandler:!1,headers:{}}).addEventListener('readystatechange',function(){var h;(2==this.readyState&&0!=this.status||3==this.readyState)&&(h=this.status,this.abort(),f(h))})},this.request=function(d){if(''==d.url||'function'!=typeof d.resulthandler)return!1;var f={method:'GET',url:'',type:'',params:'',resulthandler:this.answer,progresshandler:this.progress||!1,headers:{}};for(n in d)f[n]=d[n];0==this.filter(function(g){return g.method==f.method&&g.url==f.url&&g.params==g.params&&g.resulthandler==f.resulthandler}).length&&(this.push(f),this.action())},this.download=function(d){return new Promise(function(f){this.request({method:'GET',url:d,type:'blob',resulthandler:f})})},this.action=function(){if(!c&&0<this.length){var d=this[0];c=!0,this._xhr=(0,_Ajax2.default)({method:d.method,url:d.url,params:d.params,resulthandler:this.answer,progresshandler:d.progresshandler,headers:d.headers})}},this.answer=function(d){if(!d instanceof Error){var f=this[0].resulthandler;'function'==typeof f?f(d):'object'===('undefined'==typeof f?'undefined':_typeof(f))&&(f=d)}else console.error(d);this.pop(),this._xhr=null,c=!1,this.action()}}.extends((0,_Progressable2.default)(_Fifo2.default)));
